...
function Dashboard() {
  ...
  return (
    ...
    <div className="flex">
      ...
      <div className="bg-white shadow-md rounded-lg p-3">
        ...
        <a href="#" className="px-2 py-1 bg-gray-800 text-gray-100 font-bold rounded hover:bg-gray-700">
          View all
        </a>
        </div>
            ...
            <tbody>
              {orders.map((order) => (
                <tr key={order.id} className="border-t border-gray-300">
                  ...
                  <td className="px-2 py-2">{order.writer}</td>
                  <td className="px-2 py-2">{order.client}</td>
                  <td className="px-2 py-2">{order.bookBalance}</td>
                  <td className="px-2 py-2">{order.value}</td>
                </tr>
              ))}
            </tbody>
          </table>
  ...
  <div className="flex justify-between items-center mb-4">
    ...
    <a href="#" className="px-2 py-1 bg-gray-800 text-gray-100 font-bold rounded flex space-x-1 items-center hover:bg-gray-700">
  ...
  <ul>
    <li className="text-gray-800 mb-2 flex items-center">
      {/* <img src="writer1.jpg" alt="John Doe" className="w-8 h-8 rounded-full mr-2" /> */}
    ...
    <li className="text-gray-800 mb-2 flex items-center">
      {/* <img src="writer2.jpg" alt="Jane Smith" className="w-8 h-8 rounded-full mr-2" /> */}
      <p className="w-8 h-8 rounded-full mr-2">
      <FaUserCircle className="text-4xl pr-2"/>
      </p>
    ...
    <li className="text-gray-800 flex items-center">
      {/* <img src="writer3.jpg" alt="David Johnson" className="w-8 h-8 rounded-full mr-2" /> */}
      <p className="w-8 h-8 rounded-full mr-2">
      <FaUserCircle className="text-4xl pr-2"/>
      </p>
      <span className="font-medium">David Johnson</span>
    </li>
